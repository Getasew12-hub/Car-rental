 ...
 document.addEventListener("mousedown",(e)=>{
  ...
  return (
    <div className='flex pt-12 h-screen overflow-hidden border'>
        ...
        <div className={`space-y-5 z-30 border-r pt-8 border-gray-500 min-w-56 w-56 lg:w-64 fixed xl:w-72  md:relative top-10 bottom-0 bg-white ${!menuOpen ? "-translate-x-full " :"translate-x-0"} transition-all duration-150 md:translate-0 md:top-0` } ref={leftsidebar}>
